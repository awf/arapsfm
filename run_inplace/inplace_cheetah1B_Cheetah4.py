...
data/models/Cheetah_4.npz \
data/user_constraints/cheetah1B/{frame_index}.npz \
...
--output cheetah1B/Cheetah_4_{frame_index}_0.dat \
> cheetah1B/Cheetah_4_{frame_index}_0.log'''
...
data/models/Cheetah_4.npz \
data/user_constraints/cheetah1B/{frame_index}.npz \
cheetah1B/Cheetah_4_{frame_index}_Silhouette_Info.dat --use_linear_transform \
> cheetah1B/Cheetah_4_{frame_index}_Silhouette_Info.log'''
