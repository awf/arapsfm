# inplace_caterpillar0-Caterpillar_0.py
...
data/models/Caterpillar_0.npz \
data/user_constraints/caterpillar0/Caterpillar_0/{i:d}.npz --use_linear_transform \
"1.0,1.0" \
--solver_options "dict(maxIterations=200, improvementThreshold=1e-6)" \
--input_frame data/frames/caterpillar0/{i:d}.png \
--output Caterpillar0-Caterpillar_0/ARAP_Proj/{i:d}.dat \
> Caterpillar0-Caterpillar_0/ARAP_Proj/{i:d}.log'''
...
data/models/Caterpillar_0.npz \
data/user_constraints/caterpillar0/Caterpillar_0/{i:d}.npz --use_linear_transform \
Caterpillar0-Caterpillar_0/Silhouette_Info/{i:d}.npz \
> Caterpillar0-Caterpillar_0/Silhouette_Info/{i:d}.log'''
