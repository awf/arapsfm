...
data/models/Camel_0.npz \
data/user_constraints/camel0/Camel_0/{i:d}.npz --use_linear_transform \
"1.0,1.0" \
--solver_options "dict(maxIterations=200, improvementThreshold=1e-6)" \
--input_frame data/frames/camel0/{i:d}.png \
--output Camel0-Camel_0/ARAP_Proj/{i:d}.dat \
> Camel0-Camel_0/ARAP_Proj/{i:d}.log'''
...
data/models/Camel_0.npz \
data/user_constraints/camel0/Camel_0/{i:d}.npz --use_linear_transform \
Camel0-Camel_0/Silhouette_Info/{i:d}.npz \
> Camel0-Camel_0/Silhouette_Info/{i:d}.log'''
