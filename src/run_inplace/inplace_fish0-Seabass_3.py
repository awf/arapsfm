...
data/models/Seabass_3.npz \
data/user_constraints/fish0/Seabass_3/{i:d}.npz --use_linear_transform \
"1.0,1.0" \
--solver_options "dict(maxIterations=200, improvementThreshold=1e-6)" \
--input_frame data/frames/fish0/{i:d}.png \
--output Fish0-Seabass_3/ARAP_Proj/{i:d}.dat \
> Fish0-Seabass_3/ARAP_Proj/{i:d}.log'''
...
data/models/Seabass_3.npz \
data/user_constraints/fish0/Seabass_3/{i:d}.npz --use_linear_transform \
Fish0-Seabass_3/Silhouette_Info/{i:d}.npz \
> Fish0-Seabass_3/Silhouette_Info/{i:d}.log'''
